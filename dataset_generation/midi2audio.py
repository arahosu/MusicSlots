"""
Original code taken from midi2audio repo: https://github.com/bzamecnik/midi2audio
Credit: Bohumír Zámečník
...
class FluidSynth():
    ...
    def midi_to_audio(self, midi_file, audio_file):
        subprocess.call(['fluidsynth', '-ni', self.sound_font, midi_file, '-F', audio_file, '-r', str(self.sample_rate), '-q'])
